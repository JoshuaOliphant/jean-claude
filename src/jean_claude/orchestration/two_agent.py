...
# Mailbox tools - agents use ask_user/notify_user tools directly
...
# NOTE: Old blocker detection code removed.
# Agents now use ask_user/notify_user tools directly when they need help.
